...
#' @references Longmore, C., Fogarty, K., Neat, F., Brophy, D., Trueman, C., Milton, A. & Mariani, S. (2010) A comparison of otolith microchemistry and otolith shape analysis for the study of spatial variation in a deep-sea teleost, Coryphaenoides rupestris. Environmental Biology of Fishes, 89, 591-605.
#' @references Reist et al 1985
stdCoefs <- 
...
#'   \item info.file. A file as FISH.txt. The information is stored in the data frame master.list
